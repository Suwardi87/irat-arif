...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ri,depthTest:!1,depthWrite:!1})}function yv(n,e,t){const i=new Float32Array(Yi),s=new H(0,1,0);return new bn({name:"SphericalGaussianBlur",defines:{n:Yi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Fa(),fragmentShader:`
...
void main() {
    ...
    `,transparent:!0,blending:Yo,depthWrite:!1});h=new mg(P,N),i==null||i.add(h)}function M(){if(!t.value)return;i=new sg,i.fog=new gc(E.bg,.01),s=new sn(60,window.innerWidth/window.innerHeight,.1,1e3),s.position.set(0,0,45),r=new AM({antialias:!0,alpha:!0}),r.setSize(window.innerWidth,window.innerHeight),r.setPixelRatio(Math.min(window.devicePixelRatio,2)),r.setClearColor(E.bg,1),t.value.appendChild(r.domElement),a=new RM(s,r.domElement),a.enableDamping=!0,a.enableZoom=e.enableZoom,a.enablePan=!1,a.autoRotate=e.autoRotate,a.autoRotateSpeed=e.autoRotateSpeed,a.maxDistance=80,a.minDistance=20,a.enabled=e.enableControls;const A=new wg(16777215,.4);i.add(A),d=new Yu(16766720,2,100),d.position.set(10,10,20),i.add(d);const P=new Yu(16777215,1,50);P.position.set(-20,-10,10),i.add(P),m(),p(),w()}function w(){o=requestAnimationFrame(w),l+=.01,a==null||a.update(),u.lerp(c,.05),f&&(f.position.y=Math.sin(l*.5)*.5,f.rotation.y=u.x*.2,f.rotation.x=-u.y*.1,d&&(d.position.x=u.x*20,d.position.y=u.y*20)),h&&(h.material.uniforms.time.value=l),r==null||r.render(i,s)}function y(A){c.x=A.clientX/window.innerWidth*2-1,c.y=A.clientY/window.innerHeight*2-1}Da(()=>{M(),window.addEventListener("mousemove",y),window.addEventListener("resize",I)}),tc(()=>{o&&cancelAnimationFrame(o),window.removeEventListener("mousemove",y),window.removeEventListener("resize",I),r==null||r.dispose()});function I(){!s||!r||(s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),r.setSize(window.innerWidth,window.innerHeight))}return(A,P)=>(qt(),fn("div",GM,[j("div",{ref_key:"canvasContainer",ref:t,class:"canvas-3d"},null,512)]))}}),Mc=(n,e)=>{const t=n.__vccOpts||n;for(const[i,s]of e)t[i]=s;return t},kM=Mc(VM,[["__scopeId","data-v-f327ab74"]]),WM={key:0,class:"digital-card-overlay"},XM={class:"digital-card-container"},qM={class:"paper-card"},YM={class:"card-nav"},KM={key:0,class:"page-content"},jM={class:"card-content"},$M={class:"couple-details"},ZM={class:"person"},JM={class:"full-name"},QM={class:"parents"},eE={class:"person"},tE={class:"full-name"},nE={class:"parents"},iE={key:1,class:"page-content denah-page"},sE={class:"card-content"},rE={class:"qr-section"},aE={class:"qr-box-container"},oE={class:"qr-box"},lE=Ra({__name:"DigitalCard",props:{show:{type:Boolean},coupleData:{}},emits:["close"],setup(n,{emit:e}){const t=e,i=bi(1);function s(){t("close")}return(r,a)=>(qt(),sc(rr,{name:"book-open"},{default:bs(()=>[n.show?(qt(),fn("div",WM,[j("div",XM,[j("button",{onClick:s,class:"close-card-btn"},[...a[2]||(a[2]=[j("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[j("path",{d:"M18 6L6 18M6 6l12 12"})],-1)])]),j("div",qM,[j("div",YM,[j("button",{onClick:a[0]||(a[0]=o=>i.value=1),class:Ji({active:i.value===1})},"Halaman 1",2),j("button",{onClick:a[1]||(a[1]=o=>i.value=2),class:Ji({active:i.value===2})},"Denah Lokasi",2)]),i.value===1?(qt(),fn("div",KM,[a[8]||(a[8]=j("div",{class:"floral-top-left"},null,-1)),a[9]||(a[9]=j("div",{class:"floral-top-right"},null,-1)),j("div",jM,[a[4]||(a[4]=j("div",{class:"names-header"},[j("h1",{class:"script-font"},"Irat & Arif")],-1)),a[5]||(a[5]=j("div",{class:"greeting-section"},[j("p",{class:"bismillah-text"},"Assalamu'alaikum Warahmatullahi Wabarakatuh"),j("p",{class:"opening-text"}," Maha Suci Allah yang telah menciptakan makhluk-Nya berpasang-pasangan. Ya Allah, perkenankanlah kami merangkaikan kasih sayang yang Kau ciptakan diantara putra-putri kami: ")],-1)),j("div",$M,[j("div",ZM,[j("h2",JM,xt(n.coupleData.bride.fullName),1),j("p",QM,"Putri dari Bapak "+xt(n.coupleData.bride.father)+" dan Ibu "+xt(n.coupleData.bride.mother),1)]),a[3]||(a[3]=j("div",{class:"rings-icon"},[j("span",{class:"emoji-rings"},"💍")],-1)),j("div",eE,[j("h2",tE,xt(n.coupleData.groom.fullName),1),j("p",nE,"Putra dari Bapak "+xt(n.coupleData.groom.father)+" dan Ibu "+xt(n.coupleData.groom.mother),1)])]),a[6]||(a[6]=j("div",{class:"event-details-paper"},[j("div",{class:"event-card akad"},[j("div",{class:"date-badge"},[j("span",{class:"day"},"JUM'AT"),j("span",{class:"date"},"05"),j("span",{class:"month"},"JUNI 2026")]),j("div",{class:"info"},[j("h3",null,"Akad Nikah"),j("p",null,"Pukul: 14.00 WIB s/d Selesai"),j("p",null,"Tempat: Masjid Al-Wustha Hilir Balai")])]),j("div",{class:"event-card resepsi"},[j("div",{class:"date-badge"},[j("span",{class:"day"},"MINGGU"),j("span",{class:"date"},"07"),j("span",{class:"month"},"JUNI 2026")]),j("div",{class:"info"},[j("h3",null,"RESEPSI"),j("p",null,"Pukul: 10.00 WIB s/d Selesai"),j("p",null,"Tempat: Anak Kayu, Jorong Tabu Baraie")])])],-1)),a[7]||(a[7]=j("p",{class:"closing-greeting"},"Wassalamu'alaikum Warahmatullahi Wabarakatuh",-1))]),a[10]||(a[10]=j("div",{class:"floral-bottom-right"},null,-1))])):ii("",!0),i.value===2?(qt(),fn("div",iE,[a[15]||(a[15]=j("div",{class:"floral-top-left"},null,-1)),j("div",sE,[a[12]||(a[12]=j("div",{class:"denah-header"},[j("div",{class:"denah-icon"},"📍"),j("h2",null,"Denah Lokasi")],-1)),a[13]||(a[13]=j("div",{class:"map-illustration"},[j("div",{class:"map-box"},[j("div",{class:"road-main"}),j("div",{class:"road-branch"}),j("div",{class:"marker-location pulse"},[j("div",{class:"label-pesta"},"LOKASI PESTA")]),j("div",{class:"road-label bukittinggi"},"DARI BUKITTINGGI"),j("div",{class:"road-label padangpanjang"},"SIMP. 8 PADANG PANJANG")])],-1)),j("div",rE,[j("div",aE,[j("div",oE,[(qt(),fn(nn,null,uh(16,o=>j("div",{class:"qr-pixel",key:o})),64))])]),a[11]||(a[11]=j("p",null,"SCAN LOCATION",-1))]),a[14]||(a[14]=j("div",{class:"recipient-box"},[j("p",null,"Kepada Yth. Bapak/Ibu/Saudara/i:"),j("div",{class:"recipient-line"},[j("span",null,"Nama Tamu Undangan")])],-1))])])):ii("",!0)])])])):ii("",!0)]),_:1}))}}),cE=Mc(lE,[["__scopeId","data-v-ebe0e8e5"]]),uE={class:"gallery-container"},fE={class:"gallery-grid"},hE=["src"],dE=Ra({__name:"GalleryModal",props:{show:{type:Boolean}},emits:["close"],setup(n,{emit:e}){const t=e,i=["/public/images/contoh-1.jpeg","/public/images/contoh-2.jpeg","https://images.unsplash.com/photo-1519741497674-611481863552?w=800","https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=800"];function s(){t("close")}return(r,a)=>(qt(),sc(rr,{name:"fade"},{default:bs(()=>[n.show?(qt(),fn("div",{key:0,class:"gallery-overlay",onClick:t_(s,["self"])},[j("div",uE,[j("button",{onClick:s,class:"close-gallery-btn"},"×"),a[0]||(a[0]=j("h2",{class:"gallery-title"},"Gallery Foto",-1)),j("div",fE,[(qt(),fn(nn,null,uh(i,(o,l)=>j("div",{key:l,class:"gallery-item"},[j("img",{src:o,alt:"Wedding Photo",loading:"lazy"},null,8,hE)])),64))])])])):ii("",!0)]),_:1}))}}),pE=Mc(dE,[["__scopeId","data-v-5fce6bf6"]]),mE={key:0,class:"loader"},_E={class:"music-icon"},gE={id:"hero",class:"hero-paper"},xE={class:"paper-surface"},vE={class:"hero-main-content"},SE={class:"hero-actions"},ME={id:"details",class:"details-section"},EE={class:"paper-surface container"},yE={class:"paper-inner"},bE={class:"names-details"},TE={class:"name"},AE={class:"parents"},wE={class:"name"},RE={class:"parents"},CE={class:"event-grid-paper"},PE={class:"event-card"},DE={class:"date-badge-paper"},LE={class:"day"},IE={class:"num"},UE={class:"month"},NE={class:"event-info-paper"},FE={class:"event-card"},OE={class:"date-badge-paper"},BE={class:"day"},zE={class:"num"},HE={class:"month"},GE={class:"event-info-paper"},VE=Ra({__name:"App",setup(n){const e={bride:{fullName:"Asratul Fitri, A.Md",nickname:"Irat",title:"Putri Muslim",father:"Suhaimi",mother:"Asmi"},groom:{fullName:"Arif Hidayatulah",nickname:"Arif",title:"Putra Muslim",father:"Amrizal",mother:"Ratna Juita"},events:[{type:"akad",title:"Akad Nikah",day:"JUM'AT",date:"05",month:"JUNI 2026",time:"14.00 WIB s/d Selesai",venue:"Masjid Al-Wustha Hilir Balai",address:"Nagari Paninjauan, Kec. X Koto, Tanah Datar"},{type:"resepsi",title:"RESEPSI",day:"MINGGU",date:"07",month:"JUNI 2026",time:"10.00 WIB s/d Selesai",venue:"Anak Kayu, Jorong Tabu Baraie",address:"Nagari Paninjauan, Kec. X Koto, Tanah Datar"}]},t=bi(!0),i=bi(!1),s=bi(!1),r=bi(!1),a=bi(null),o=bi(!1);Da(()=>{setTimeout(()=>{t.value=!1},2e3);const h=()=>{o.value=window.scrollY>300};window.addEventListener("scroll",h,{passive:!0}),h()});function l(){a.value||(a.value=new Audio("/music/wedding.mp3"),a.value.loop=!0),r.value?a.value.pause():a.value.play(),r.value=!r.value}function c(h){var f;(f=document.getElementById(h))==null||f.scrollIntoView({behavior:"smooth"})}function u(){var h;window.scrollTo({top:0,behavior:"smooth"}),(h=document.getElementById("hero"))==null||h.scrollIntoView({behavior:"smooth"})}return(h,f)=>(qt(),fn(nn,null,[Rt(kM),Rt(rr,{name:"fade"},{default:bs(()=>[t.value?(qt(),fn("div",mE,[...f[6]||(f[6]=[j("div",{class:"loader-content"},[j("div",{class:"loader-bismillah"},"بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيم"),j("div",{class:"loader-ring"}),j("p",{class:"loader-text"},"MEMUAT UNDANGAN...")],-1)])])):ii("",!0)]),_:1}),Rt(cE,{show:i.value,"couple-data":e,onClose:f[0]||(f[0]=d=>i.value=!1)},null,8,["show"]),Rt(pE,{show:s.value,onClose:f[1]||(f[1]=d=>s.value=!1)},null,8,["show"]),t.value?ii("",!0):(qt(),fn("button",{key:0,onClick:l,class:Ji(["music-btn",{playing:r.value}])},[j("span",_E,xt(r.value?"♪":"♫"),1)],2)),Rt(rr,{name:"bounce-up"},{default:bs(()=>[t.value?ii("",!0):(qt(),fn("button",{key:0,onClick:f[2]||(f[2]=d=>i.value=!0),class:"fab-open"},[...f[7]||(f[7]=[j("span",{class:"fab-icon"},"💌",-1),j("span",{class:"fab-text"},"Buka Undangan",-1)])]))]),_:1}),Rt(rr,{name:"fade"},{default:bs(()=>[o.value?(qt(),fn("button",{key:0,onClick:u,class:"back-to-top"},[...f[8]||(f[8]=[j("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[j("path",{d:"M12 19V5M5 12l7-7 7 7"})],-1)])])):ii("",!0)]),_:1}),j("div",{class:Ji(["invitation-wrapper",{"blur-bg":i.value||s.value}])},[j("section",gE,[j("div",xE,[f[14]||(f[14]=j("div",{class:"floral-top-left"},null,-1)),f[15]||(f[15]=j("div",{class:"floral-top-right"},null,-1)),j("div",vE,[f[12]||(f[12]=j("div",{class:"bismillah-gold"},"Assalamu'alaikum Warahmatullahi Wabarakatuh",-1)),f[13]||(f[13]=j("div",{class:"couple-names-large"},[j("h1",{class:"irat-arif"},[ea("Irat "),j("span",{class:"ampersand"},"&"),ea(" Arif")])],-1)),j("div",SE,[j("button",{onClick:f[3]||(f[3]=d=>i.value=!0),class:"btn-card"},[...f[9]||(f[9]=[j("span",null,"BUKA UNDANGAN",-1)])]),j("button",{onClick:f[4]||(f[4]=d=>s.value=!0),class:"btn-gallery"},[...f[10]||(f[10]=[j("span",null,"GALLERY FOTO",-1)])])]),j("button",{onClick:f[5]||(f[5]=d=>c("details")),class:"scroll-down"},[...f[11]||(f[11]=[j("svg",{width:"30",height:"30",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[j("path",{d:"M7 13l5 5 5-5M7 6l5 5 5-5"})],-1)])])]),f[16]||(f[16]=j("div",{class:"floral-bottom-right"},null,-1))])]),j("section",ME,[j("div",EE,[j("div",yE,[f[21]||(f[21]=j("p",{class:"opening-text"}," Maha Suci Allah yang telah menciptakan makhluk-Nya berpasang-pasangan. Ya Allah, perkenankanlah kami merangkaikan kasih sayang yang Kau ciptakan diantara putra-putri kami: ",-1)),j("div",bE,[j("h2",TE,xt(e.bride.fullName),1),j("p",AE,"Putri dari Bapak "+xt(e.bride.father)+" dan Ibu "+xt(e.bride.mother),1),f[17]||(f[17]=j("div",{class:"rings-gold"},"💍",-1)),j("h2",wE,xt(e.groom.fullName),1),j("p",RE,"Putra dari Bapak "+xt(e.groom.father)+" dan Ibu "+xt(e.groom.mother),1)]),j("div",CE,[j("div",PE,[j("div",DE,[j("span",LE,xt(e.events[0].day),1),j("span",IE,xt(e.events[0].date),1),j("span",UE,xt(e.events[0].month),1)]),j("div",NE,[f[18]||(f[18]=j("h3",null,"AKAD NIKAH",-1)),j("p",null,xt(e.events[0].time),1),j("p",null,xt(e.events[0].venue),1)])]),j("div",FE,[j("div",OE,[j("span",BE,xt(e.events[1].day),1),j("span",zE,xt(e.events[1].date),1),j("span",HE,xt(e.events[1].month),1)]),j("div",GE,[f[19]||(f[19]=j("h3",null,"RESEPSI",-1)),j("p",null,xt(e.events[1].time),1),j("p",null,xt(e.events[1].venue),1)])])]),j("button",{onClick:u,class:"back-to-top-section"},[...f[20]||(f[20]=[j("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[j("path",{d:"M12 19V5M5 12l7-7 7 7"})],-1),ea(" Kembali ke Atas ",-1)])])])])])],2)],64))}});s_(VE).mount("#app");
