...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ri,depthTest:!1,depthWrite:!1})}function yv(n,e,t){const i=new Float32Array(qi),s=new H(0,1,0);return new bn({name:"SphericalGaussianBlur",defines:{n:qi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Fa(),fragmentShader:`
		...
		`,blending:ri,depthTest:!1,depthWrite:!1})}function tf(){return new bn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Fa(),fragmentShader:`
		...
		`,blending:ri,depthTest:!1,depthWrite:!1})}function nf(){return new bn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fa(),fragmentShader:`
...
`)}function DS(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Js).join(`
...
void main() {
    ...
    `,transparent:!0,blending:Yo,depthWrite:!1});h=new mg(P,N),i==null||i.add(h)}function M(){if(!t.value)return;i=new sg,i.fog=new gc(E.bg,.01),s=new sn(60,window.innerWidth/window.innerHeight,.1,1e3),s.position.set(0,0,45),r=new AM({antialias:!0,alpha:!0}),r.setSize(window.innerWidth,window.innerHeight),r.setPixelRatio(Math.min(window.devicePixelRatio,2)),r.setClearColor(E.bg,1),t.value.appendChild(r.domElement),a=new RM(s,r.domElement),a.enableDamping=!0,a.enableZoom=e.enableZoom,a.enablePan=!1,a.autoRotate=e.autoRotate,a.autoRotateSpeed=e.autoRotateSpeed,a.maxDistance=80,a.minDistance=20,a.enabled=e.enableControls;const A=new wg(16777215,.4);i.add(A),d=new Yu(16766720,2,100),d.position.set(10,10,20),i.add(d);const P=new Yu(16777215,1,50);P.position.set(-20,-10,10),i.add(P),m(),p(),w()}function w(){o=requestAnimationFrame(w),l+=.01,a==null||a.update(),u.lerp(c,.05),f&&(f.position.y=Math.sin(l*.5)*.5,f.rotation.y=u.x*.2,f.rotation.x=-u.y*.1,d&&(d.position.x=u.x*20,d.position.y=u.y*20)),h&&(h.material.uniforms.time.value=l),r==null||r.render(i,s)}function y(A){c.x=A.clientX/window.innerWidth*2-1,c.y=A.clientY/window.innerHeight*2-1}Da(()=>{M(),window.addEventListener("mousemove",y),window.addEventListener("resize",I)}),tc(()=>{o&&cancelAnimationFrame(o),window.removeEventListener("mousemove",y),window.removeEventListener("resize",I),r==null||r.dispose()});function I(){!s||!r||(s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),r.setSize(window.innerWidth,window.innerHeight))}return(A,P)=>(qt(),fn("div",GM,[Y("div",{ref_key:"canvasContainer",ref:t,class:"canvas-3d"},null,512)]))}}),Mc=(n,e)=>{const t=n.__vccOpts||n;for(const[i,s]of e)t[i]=s;return t},kM=Mc(VM,[["__scopeId","data-v-9ebbdb88"]]),WM={key:0,class:"digital-card-overlay"},XM={class:"digital-card-container"},qM={class:"book-container"},YM={class:"paper-card"},KM={class:"card-nav"},jM={key:"page1",class:"page-content"},$M={class:"card-content"},ZM={class:"couple-details"},JM={class:"person"},QM={class:"nick-name"},eE={class:"full-name-small"},tE={class:"parents"},nE={class:"person"},iE={class:"nick-name"},sE={class:"full-name-small"},rE={class:"parents"},aE={key:"page2",class:"page-content denah-page"},oE={class:"card-content"},lE={class:"qr-section"},cE={class:"qr-box-container"},uE={class:"qr-box"},fE=Ra({__name:"DigitalCard",props:{show:{type:Boolean},coupleData:{}},emits:["close"],setup(n,{emit:e}){const t=e,i=ti(1),s=ti(!1);function r(){t("close")}function a(o){o!==i.value&&!s.value&&(s.value=!0,setTimeout(()=>{i.value=o,setTimeout(()=>{s.value=!1},600)},300))}return(o,l)=>(qt(),sc(As,{name:"book-open"},{default:Ji(()=>[n.show?(qt(),fn("div",WM,[Y("div",XM,[Y("button",{onClick:r,class:"close-card-btn"},[...l[2]||(l[2]=[Y("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[Y("path",{d:"M18 6L6 18M6 6l12 12"})],-1)])]),Y("div",qM,[l[16]||(l[16]=Y("div",{class:"page-sheet page-back-3"},null,-1)),l[17]||(l[17]=Y("div",{class:"page-sheet page-back-2"},null,-1)),l[18]||(l[18]=Y("div",{class:"page-sheet page-back-1"},null,-1)),Y("div",YM,[Y("div",KM,[Y("button",{onClick:l[0]||(l[0]=c=>a(1)),class:Qi({active:i.value===1})},"Halaman 1",2),Y("button",{onClick:l[1]||(l[1]=c=>a(2)),class:Qi({active:i.value===2})},"Denah Lokasi",2)]),wt(As,{name:"page-turn",mode:"out-in"},{default:Ji(()=>[i.value===1?(qt(),fn("div",jM,[l[8]||(l[8]=Y("div",{class:"floral-top-left"},null,-1)),l[9]||(l[9]=Y("div",{class:"floral-top-right"},null,-1)),Y("div",$M,[l[4]||(l[4]=Y("div",{class:"names-header"},[Y("h1",{class:"script-font"},"Irat & Arif")],-1)),l[5]||(l[5]=Y("div",{class:"greeting-section"},[Y("p",{class:"bismillah-text"},"Assalamu'alaikum Warahmatullahi Wabarakatuh"),Y("p",{class:"opening-text"}," Maha Suci Allah yang telah menciptakan makhluk-Nya berpasang-pasangan. Ya Allah, perkenankanlah kami merangkaikan kasih sayang yang Kau ciptakan diantara putra-putri kami: ")],-1)),Y("div",ZM,[Y("div",JM,[Y("h2",QM,ht(n.coupleData.bride.nickname),1),Y("p",eE,ht(n.coupleData.bride.fullName),1),Y("p",tE,"Putri dari Bapak "+ht(n.coupleData.bride.father)+" dan Ibu "+ht(n.coupleData.bride.mother),1)]),l[3]||(l[3]=Y("div",{class:"rings-icon"},[Y("span",{class:"emoji-rings"},"💍")],-1)),Y("div",nE,[Y("h2",iE,ht(n.coupleData.groom.nickname),1),Y("p",sE,ht(n.coupleData.groom.fullName),1),Y("p",rE,"Putra dari Bapak "+ht(n.coupleData.groom.father)+" dan Ibu "+ht(n.coupleData.groom.mother),1)])]),l[6]||(l[6]=Y("div",{class:"event-details-paper"},[Y("div",{class:"event-card akad"},[Y("div",{class:"date-badge"},[Y("span",{class:"day"},"JUM'AT"),Y("span",{class:"date"},"05"),Y("span",{class:"month"},"JUNI 2026")]),Y("div",{class:"info"},[Y("h3",null,"Akad Nikah"),Y("p",null,"Pukul: 14.00 WIB s/d Selesai"),Y("p",null,"Tempat: Masjid Al-Wustha Hilir Balai")])]),Y("div",{class:"event-card resepsi"},[Y("div",{class:"date-badge"},[Y("span",{class:"day"},"MINGGU"),Y("span",{class:"date"},"07"),Y("span",{class:"month"},"JUNI 2026")]),Y("div",{class:"info"},[Y("h3",null,"RESEPSI"),Y("p",null,"Pukul: 10.00 WIB s/d Selesai"),Y("p",null,"Tempat: Anak Kayu, Jorong Tabu Baraie")])])],-1)),l[7]||(l[7]=Y("p",{class:"closing-greeting"},"Wassalamu'alaikum Warahmatullahi Wabarakatuh",-1))]),l[10]||(l[10]=Y("div",{class:"floral-bottom-right"},null,-1))])):(qt(),fn("div",aE,[l[15]||(l[15]=Y("div",{class:"floral-top-left"},null,-1)),Y("div",oE,[l[12]||(l[12]=Y("div",{class:"denah-header"},[Y("div",{class:"denah-icon"},"📍"),Y("h2",null,"Denah Lokasi")],-1)),l[13]||(l[13]=Y("div",{class:"map-illustration"},[Y("div",{class:"map-box"},[Y("div",{class:"road-main"}),Y("div",{class:"road-branch"}),Y("div",{class:"marker-location pulse"},[Y("div",{class:"label-pesta"},"LOKASI PESTA")]),Y("div",{class:"road-label bukittinggi"},"DARI BUKITTINGGI"),Y("div",{class:"road-label padangpanjang"},"SIMP. 8 PADANG PANJANG")])],-1)),Y("div",lE,[Y("div",cE,[Y("div",uE,[(qt(),fn(nn,null,uh(16,c=>Y("div",{class:"qr-pixel",key:c})),64))])]),l[11]||(l[11]=Y("p",null,"SCAN LOCATION",-1))]),l[14]||(l[14]=Y("div",{class:"recipient-box"},[Y("p",null,"Kepada Yth. Bapak/Ibu/Saudara/i:"),Y("div",{class:"recipient-line"},[Y("span",null,"Nama Tamu Undangan")])],-1))])]))]),_:1})])])])])):Yi("",!0)]),_:1}))}}),hE=Mc(fE,[["__scopeId","data-v-43e1caca"]]),dE={class:"gallery-container"},pE={class:"gallery-grid"},mE=["src"],_E=Ra({__name:"GalleryModal",props:{show:{type:Boolean}},emits:["close"],setup(n,{emit:e}){const t=e,i=["/public/images/contoh-1.jpeg","/public/images/contoh-2.jpeg","https://images.unsplash.com/photo-1519741497674-611481863552?w=800","https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=800"];function s(){t("close")}return(r,a)=>(qt(),sc(As,{name:"fade"},{default:Ji(()=>[n.show?(qt(),fn("div",{key:0,class:"gallery-overlay",onClick:t_(s,["self"])},[Y("div",dE,[Y("button",{onClick:s,class:"close-gallery-btn"},"×"),a[0]||(a[0]=Y("h2",{class:"gallery-title"},"Gallery Foto",-1)),Y("div",pE,[(qt(),fn(nn,null,uh(i,(o,l)=>Y("div",{key:l,class:"gallery-item"},[Y("img",{src:o,alt:"Wedding Photo",loading:"lazy"},null,8,mE)])),64))])])])):Yi("",!0)]),_:1}))}}),gE=Mc(_E,[["__scopeId","data-v-5fce6bf6"]]),xE={key:0,class:"loader"},vE={class:"music-icon"},SE={id:"hero",class:"hero-paper"},ME={class:"paper-surface"},EE={class:"hero-main-content"},yE={class:"hero-actions"},bE={id:"details",class:"details-section"},TE={class:"paper-surface container"},AE={class:"paper-inner"},wE={class:"names-details"},RE={class:"name"},CE={class:"name-full"},PE={class:"parents"},DE={class:"name"},LE={class:"name-full"},IE={class:"parents"},UE={class:"event-grid-paper"},NE={class:"event-card"},FE={class:"date-badge-paper"},OE={class:"day"},BE={class:"num"},zE={class:"month"},HE={class:"event-info-paper"},GE={class:"event-card"},VE={class:"date-badge-paper"},kE={class:"day"},WE={class:"num"},XE={class:"month"},qE={class:"event-info-paper"},YE=Ra({__name:"App",setup(n){const e={bride:{fullName:"Asratul Fitri, A.Md",nickname:"Irat",title:"Putri Muslim",father:"Suhaimi",mother:"Asmi"},groom:{fullName:"Arif Hidayatulah",nickname:"Arif",title:"Putra Muslim",father:"Amrizal",mother:"Ratna Juita"},events:[{type:"akad",title:"Akad Nikah",day:"JUM'AT",date:"05",month:"JUNI 2026",time:"14.00 WIB s/d Selesai",venue:"Masjid Al-Wustha Hilir Balai",address:"Nagari Paninjauan, Kec. X Koto, Tanah Datar"},{type:"resepsi",title:"RESEPSI",day:"MINGGU",date:"07",month:"JUNI 2026",time:"10.00 WIB s/d Selesai",venue:"Anak Kayu, Jorong Tabu Baraie",address:"Nagari Paninjauan, Kec. X Koto, Tanah Datar"}]},t=ti(!0),i=ti(!1),s=ti(!1),r=ti(!1),a=ti(null),o=ti(!1);Da(()=>{setTimeout(()=>{t.value=!1},2e3);const h=()=>{o.value=window.scrollY>300};window.addEventListener("scroll",h,{passive:!0}),h()});function l(){a.value||(a.value=new Audio("/music/wedding.mp3"),a.value.loop=!0),r.value?a.value.pause():a.value.play(),r.value=!r.value}function c(h){var f;(f=document.getElementById(h))==null||f.scrollIntoView({behavior:"smooth"})}function u(){var h;window.scrollTo({top:0,behavior:"smooth"}),(h=document.getElementById("hero"))==null||h.scrollIntoView({behavior:"smooth"})}return(h,f)=>(qt(),fn(nn,null,[wt(kM),wt(As,{name:"fade"},{default:Ji(()=>[t.value?(qt(),fn("div",xE,[...f[6]||(f[6]=[Y("div",{class:"loader-content"},[Y("div",{class:"loader-bismillah"},"بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيم"),Y("div",{class:"loader-ring"}),Y("p",{class:"loader-text"},"MEMUAT UNDANGAN...")],-1)])])):Yi("",!0)]),_:1}),wt(hE,{show:i.value,"couple-data":e,onClose:f[0]||(f[0]=d=>i.value=!1)},null,8,["show"]),wt(gE,{show:s.value,onClose:f[1]||(f[1]=d=>s.value=!1)},null,8,["show"]),t.value?Yi("",!0):(qt(),fn("button",{key:0,onClick:l,class:Qi(["music-btn",{playing:r.value}])},[Y("span",vE,ht(r.value?"♪":"♫"),1)],2)),wt(As,{name:"bounce-up"},{default:Ji(()=>[t.value?Yi("",!0):(qt(),fn("button",{key:0,onClick:f[2]||(f[2]=d=>i.value=!0),class:"fab-open"},[...f[7]||(f[7]=[Y("span",{class:"fab-icon"},"💌",-1),Y("span",{class:"fab-text"},"Buka Undangan",-1)])]))]),_:1}),wt(As,{name:"fade"},{default:Ji(()=>[o.value?(qt(),fn("button",{key:0,onClick:u,class:"back-to-top"},[...f[8]||(f[8]=[Y("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[Y("path",{d:"M12 19V5M5 12l7-7 7 7"})],-1)])])):Yi("",!0)]),_:1}),Y("div",{class:Qi(["invitation-wrapper",{"blur-bg":i.value||s.value}])},[Y("section",SE,[Y("div",ME,[f[14]||(f[14]=Y("div",{class:"floral-top-left"},null,-1)),f[15]||(f[15]=Y("div",{class:"floral-top-right"},null,-1)),Y("div",EE,[f[12]||(f[12]=Y("div",{class:"bismillah-gold"},"Assalamu'alaikum Warahmatullahi Wabarakatuh",-1)),f[13]||(f[13]=Y("div",{class:"couple-names-large"},[Y("h1",{class:"irat-arif"},[ea("Irat "),Y("span",{class:"ampersand"},"&"),ea(" Arif")])],-1)),Y("div",yE,[Y("button",{onClick:f[3]||(f[3]=d=>i.value=!0),class:"btn-card"},[...f[9]||(f[9]=[Y("span",null,"BUKA UNDANGAN",-1)])]),Y("button",{onClick:f[4]||(f[4]=d=>s.value=!0),class:"btn-gallery"},[...f[10]||(f[10]=[Y("span",null,"GALLERY FOTO",-1)])])]),Y("button",{onClick:f[5]||(f[5]=d=>c("details")),class:"scroll-down"},[...f[11]||(f[11]=[Y("svg",{width:"30",height:"30",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[Y("path",{d:"M7 13l5 5 5-5M7 6l5 5 5-5"})],-1)])])]),f[16]||(f[16]=Y("div",{class:"floral-bottom-right"},null,-1))])]),Y("section",bE,[Y("div",TE,[Y("div",AE,[f[21]||(f[21]=Y("p",{class:"opening-text"}," Maha Suci Allah yang telah menciptakan makhluk-Nya berpasang-pasangan. Ya Allah, perkenankanlah kami merangkaikan kasih sayang yang Kau ciptakan diantara putra-putri kami: ",-1)),Y("div",wE,[Y("h2",RE,ht(e.bride.nickname),1),Y("p",CE,ht(e.bride.fullName),1),Y("p",PE,"Dari Bapak "+ht(e.bride.father)+" & Ibu "+ht(e.bride.mother),1),f[17]||(f[17]=Y("div",{class:"rings-gold"},"💍",-1)),Y("h2",DE,ht(e.groom.nickname),1),Y("p",LE,ht(e.groom.fullName),1),Y("p",IE,"Dari Bapak "+ht(e.groom.father)+" & Ibu "+ht(e.groom.mother),1)]),Y("div",UE,[Y("div",NE,[Y("div",FE,[Y("span",OE,ht(e.events[0].day),1),Y("span",BE,ht(e.events[0].date),1),Y("span",zE,ht(e.events[0].month),1)]),Y("div",HE,[f[18]||(f[18]=Y("h3",null,"AKAD NIKAH",-1)),Y("p",null,ht(e.events[0].time),1),Y("p",null,ht(e.events[0].venue),1)])]),Y("div",GE,[Y("div",VE,[Y("span",kE,ht(e.events[1].day),1),Y("span",WE,ht(e.events[1].date),1),Y("span",XE,ht(e.events[1].month),1)]),Y("div",qE,[f[19]||(f[19]=Y("h3",null,"RESEPSI",-1)),Y("p",null,ht(e.events[1].time),1),Y("p",null,ht(e.events[1].venue),1)])])]),Y("button",{onClick:u,class:"back-to-top-section"},[...f[20]||(f[20]=[Y("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[Y("path",{d:"M12 19V5M5 12l7-7 7 7"})],-1),ea(" Kembali ke Atas ",-1)])])])])])],2)],64))}});s_(YE).mount("#app");
